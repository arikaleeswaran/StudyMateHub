...
// A beautiful dark-themed loader to show while chunks are downloading
const PageLoader = () => (
  <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', width: '100vw', background: '#0f172a' }}>
    <div style={{ width: '50px', height: '50px', border: '5px solid rgba(255,255,255,0.1)', borderTop: '5px solid #00d2ff', borderRadius: '50%', animation: 'spin 1s linear infinite' }}></div>
